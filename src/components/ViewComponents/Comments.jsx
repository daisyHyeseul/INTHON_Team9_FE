...
export default function Comments ({setComment, mode}){
    ...
    <div className='flex flex-col justify-start items-start text-white w-5/6 rounded-2xl gap-4' >
      ...
      <div className="transition-all duration-100 writing-area cont flex flex-col justify-start items-start text-white w-full p-6 rounded-2xl h-auto" style={{backgroundColor:'#5B4C7D'}}>
