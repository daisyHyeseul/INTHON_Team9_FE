...
export default function LoginForm (){
    ...
    return (
        <div className="login-form-container w-full h-full flex flex-col justify-center items-center gap-10">
            ...
            <div className="form-group flex flex-col text-white w-5/6 gap-2">
                <label className="form-label  text-base">비밀번호 <span className="subtext text-xs ml-2 text-purple-200">*문자로 전송되었던 비밀번호를 입력해주세요</span></label>
                <input
                    type="password"
            ...
            <button onClick={isValid} className="submit-button text-black w-5/6 bg-white px-5 py-2 rounded-3xl">입장하기</button>
        </div>
    )
}
