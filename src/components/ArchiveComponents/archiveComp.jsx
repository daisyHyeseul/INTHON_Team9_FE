...
export default function ArchiveComponents({ date, isnew,type, summary, writer, title }) {
    // 날짜 포맷
    ...
    const handleClick = () => {
        ...
        navigate('/lastview', { state: dataToPass });
    };

    return (
        <div className="archive-grid h-1/3 mb-5 rounded-3xl p-4 flex flex-col overflow-auto justify-around gap-2"
